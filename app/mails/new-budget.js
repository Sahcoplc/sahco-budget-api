...
const newBudget = ({ name, department, operator, title = "New Budget", budgetId }) => 
`<!DOCTYPE html>

    <head>
      <title>Skyway Aviation Handling Company Plc.</title>
      <meta charset="UTF-8">
      ...
      <div style="font-family:'Poppins',sans-serif;background-color:rgb(235,239,244)">
                                                                                            ...
                                                                                            <tr
                                                                                                ...
                                                                                                <td style="padding:10px;line-height:36px;text-align:inherit;font-family:'Poppins',sans-serif;background-color:rgb(235,239,244)"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <p
                                                                                                            style="font-size:15px;font-family:'Poppins',sans-serif;color:rgb(30,35,41)">
                                                                                                            A new budget has been submitted by ${operator} of ${department}. Click here to <a href="https://database-app-nine.vercel.app/budget/${budgetId}">view</a> it.
                                                                                                        </p>
                                                                                                        ...
                                                                                                        <div>
                                                                                                            <span style="display: block;line-height: 1.2;">SAHCO PLC</span>
                                                                                                            <img style="height:33px;width:auto;margin:5rem auto 1rem;font-family:'Poppins',sans-serif"
                                                                                                            src="https://sahcoplc.com/wp-content/uploads/2019/06/sifax-sahco-logo-brand-2.png"
                                                                                                            alt="SAHCO logo"
                                                                                                            class="CToWUd"
        ...
        <p
            style="font-family:'Poppins',sans-serif;color:#fff">
              You received this email because you signed up to SAHCO Plc.
        </p>
        <p
            style="font-size:12px;line-height:24px;font-family:'Poppins',sans-serif;color:#fff">
            SAHCO Plc. <br>
            Muritala Muhammed Airport, Ikeja
            Lagos, Nigeria
        </p>
        <p
            style="font-family:'Poppins',sans-serif;color:#fff">
